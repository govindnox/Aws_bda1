...
class SQSAggregationMessage:
    ...
    def from_sqs_record(cls, record: Dict[str, Any]) -> "SQSAggregationMessage":
        ...
        if not app_no:
            raise ValueError(
                "SQS aggregation message missing required 'app_no' field"
            )
        if not process:
            raise ValueError(
                "SQS aggregation message missing required 'process' field"
            )
...
class ProcessConfig:
    ...
    ocr_engine: str = "docling"  # "docling" | "textract"
    ...
    def from_dynamo_item(cls, item: Dict[str, Any]) -> "ProcessConfig":
        ...
        return cls(
            ...
            confidence_configuration=item.get("confidence_configuration", {}),
...
class ExtractionResult:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "fields": {
                name: fld.to_dict() for name, fld in self.fields.items()
            },
