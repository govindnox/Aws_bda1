...
Author: Reet Roy
Version: 3.1.1 (CR-12 fixes)

Modification History:
    2026-04-21 - CR-12: FileState imported from models.data_models.
"""
...
# CR-12: Single authoritative FileState definition lives in data_models.
from models.data_models import FileState  # noqa: F401  (re-exported)
...
def update_file_state(
    ...
    try:
        ...
        logger.info(
            "Updated file state: path=%s, process=%s, new_state=%s",
            path,
            process,
            new_state.value,
        )
